...
public class HRACOSVisitor extends HRACGrammarBaseVisitor<HRACAbstractDirectiveExpressionTreeNode> {
	private HRACAbstractDirectiveExpressionTreeNode o;

	@Override
	public HRACAbstractDirectiveExpressionTreeNode visitCnt_specify(Cnt_specifyContext ctx) {
	...
	@Override
	public HRACAbstractDirectiveExpressionTreeNode visitOffset_specify_number(Offset_specify_numberContext ctx) {
		o = (ctx.par_expr().accept(new HRACExpressionVisitor()));
		return o;
	}
}
